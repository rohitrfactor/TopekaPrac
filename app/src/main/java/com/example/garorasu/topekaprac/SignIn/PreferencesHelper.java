...
public class PreferencesHelper {
    ...
    /**
     * Writes a {@link com.example.garorasu.topekaprac.SignIn.Player} to preferences.
     *
     * @param context The Context which to obtain the SharedPreferences from.
     * @param player  The {@link com.example.garorasu.topekaprac.SignIn.Player} to write.
     */
    ...
    /**
     * Retrieves a {@link com.example.garorasu.topekaprac.SignIn.Player} from preferences.
     *
     * @param context The Context which to obtain the SharedPreferences from.
